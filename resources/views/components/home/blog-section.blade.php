<section class="bg-white dark:bg-gray-900">
    <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
        <div class="mx-auto mb-8 flex max-w-screen-sm flex-col items-center justify-center text-center lg:mb-16">
            ...
            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white lg:text-4xl">GDSC Blog
            </h2>



            <p class="font-light text-gray-500 dark:text-gray-400 sm:text-xl">Feel free to share your knowledge across
                the platform!</p>
        </div>
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <article
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <img alt="Bonnie Green avatar" class="h-7 w-7 rounded-full"
