...
<x-app-Layout>
        ...
        <div class="mx-auto flex max-w-screen-xl justify-between px-4">
            <article
                ...
                <header class="not-format mb-4 lg:mb-6">
                    <address class="mb-6 flex items-center not-italic">
                        <div class="mr-3 inline-flex items-center text-sm text-gray-900 dark:text-white">
                            <img alt="Jese Leos" class="mr-4 h-16 w-16 rounded-full"
                            ...
                            <div>
                                ...
                                <p class="text-base text-gray-500 dark:text-gray-400"><time datetime="2022-02-08"
                                        pubdate title="February 8th, 2022">Feb. 8, 2022</time></p>
                            </div>
                        </div>
                    </address>
                    <h1
                ...
                <p>A serif is a small shape or projection that appears at the beginning or end of a stroke on a letter.
                    Typefaces with serifs are called serif typefaces. Serif fonts are classified as one of the
                    following:</p>
                <pre><code class="language-html">&lt;dl class="grid max-w-screen-md grid-cols-2 gap-8 text-gray-900 dark:text-white sm:grid-cols-3"&gt;
  ...
  &lt;/dl&gt;
                ...
                <section class="not-format">
                    ...
                    <form class="mb-6">
                        <div
                            ...
                            <textarea
                                ...
                                id="comment" placeholder="Write a comment..." required rows="6"></textarea>
                        </div>
                        <button
                    ...
                    <article class="mb-6 rounded-lg bg-white p-6 text-base dark:bg-gray-900">
                        <footer class="mb-2 flex items-center justify-between">
                            <div class="flex items-center">
                                <p
                                    ...
                                    <img alt="Michael Gough" class="mr-2 h-6 w-6 rounded-full"
                                        src="https://flowbite.com/docs/images/people/profile-picture-2.jpg">Michael
                                    Gough
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-400"><time datetime="2022-02-08" pubdate
                            ...
                            <button
                                ...
                                <svg aria-hidden="true" class="h-4 w-4" fill="currentColor" viewBox="0 0 16 3"
                            ...
                            <!-- Dropdown menu -->
                            <div class="z-10 hidden w-36 divide-y divide-gray-100 rounded bg-white shadow dark:divide-gray-600 dark:bg-gray-700"
                                id="dropdownComment1">
                        ...
                        <div class="mt-4 flex items-center space-x-4">
                            <button
                                ...
                                type="button">
                                <svg aria-hidden="true" class="mr-1.5 h-3 w-3" fill="currentColor" viewBox="0 0 20 18"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <article class="mb-6 ml-6 rounded-lg bg-white p-6 text-base dark:bg-gray-900 lg:ml-12">
                        <footer class="mb-2 flex items-center justify-between">
                            <div class="flex items-center">
                                <p
                                    class="mr-3 inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                                    <img alt="Jese Leos" class="mr-2 h-6 w-6 rounded-full"
                                        src="https://flowbite.com/docs/images/people/profile-picture-5.jpg">Jese Leos
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-400"><time datetime="2022-02-12" pubdate
                                        title="February 12th, 2022">Feb. 12, 2022</time></p>
                            </div>
                            <button
                                class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                data-dropdown-toggle="dropdownComment2" id="dropdownComment2Button" type="button">
                                <svg aria-hidden="true" class="h-4 w-4" fill="currentColor" viewBox="0 0 16 3"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M2 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm6.041 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM14 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z" />
                        ...
                        <div class="mt-4 flex items-center space-x-4">
                            <button
                                class="flex items-center text-sm font-medium text-gray-500 hover:underline dark:text-gray-400"
                                type="button">
                                <svg aria-hidden="true" class="mr-1.5 h-3 w-3" fill="currentColor"
                    ...
                    <article
                        class="mb-6 border-t border-gray-200 bg-white p-6 text-base dark:border-gray-700 dark:bg-gray-900">
                        <footer class="mb-2 flex items-center justify-between">
                            <div class="flex items-center">
                                <p
                                    class="mr-3 inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                                    <img alt="Bonnie Green" class="mr-2 h-6 w-6 rounded-full"
                                        src="https://flowbite.com/docs/images/people/profile-picture-3.jpg">Bonnie
                                    Green
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-400"><time datetime="2022-03-12"
                                        pubdate title="March 12th, 2022">Mar. 12, 2022</time></p>
                            </div>
                            <button
                                class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                data-dropdown-toggle="dropdownComment3" id="dropdownComment3Button" type="button">
                                <svg aria-hidden="true" class="h-4 w-4" fill="currentColor" viewBox="0 0 16 3"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M2 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm6.041 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM14 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z" />
                    ...
                    <article
                        ...
                        <footer class="mb-2 flex items-center justify-between">
                            <div class="flex items-center">
                                <p
                                    class="mr-3 inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                                    <img alt="Helene Engels" class="mr-2 h-6 w-6 rounded-full"
                                        src="https://flowbite.com/docs/images/people/profile-picture-4.jpg">Helene
                                    Engels
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-400"><time datetime="2022-06-23"
                                        pubdate title="June 23rd, 2022">Jun. 23, 2022</time></p>
                            </div>
                            <button
                                class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                data-dropdown-toggle="dropdownComment4" id="dropdownComment4Button" type="button">
                                <svg aria-hidden="true" class="h-4 w-4" fill="currentColor" viewBox="0 0 16 3"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M2 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm6.041 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM14 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z" />
        ...
        <div class="mx-auto max-w-screen-xl px-4">
            ...
            <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                <article class="max-w-xs">
                    <a href="#">
                        <img alt="Image 1" class="mb-5 rounded-lg"
                    ...
                    <a class="inline-flex items-center font-medium text-primary-600 underline underline-offset-4 hover:no-underline dark:text-primary-500"
                        href="#">
                        Read in 2 minutes
                    </a>
                </article>
                <article class="max-w-xs">
                    <a href="#">
                        <img alt="Image 2" class="mb-5 rounded-lg"
                ...
                <article class="max-w-xs">
                    <a href="#">
                        <img alt="Image 3" class="mb-5 rounded-lg"
                ...
                <article class="max-w-xs">
                    <a href="#">
                        <img alt="Image 4" class="mb-5 rounded-lg"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
            <div class="mx-auto max-w-screen-md sm:text-center">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Sign
                    up
                    for our newsletter</h2>
                <p class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400 sm:text-xl md:mb-12">Stay up to date
                    with
                    the roadmap progress, announcements and exclusive discounts feel free to sign up with your email.
                </p>
                <form action="#">
                    <div class="mx-auto mb-3 max-w-screen-sm items-center space-y-4 sm:flex sm:space-y-0">
                        <div class="relative w-full">
                            <label class="mb-2 hidden text-sm font-medium text-gray-900 dark:text-gray-300"
                        ...
                        <div>
                            <button
                                class="w-full cursor-pointer rounded-lg border border-primary-600 bg-primary-700 px-5 py-3 text-center text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:rounded-none sm:rounded-r-lg"
