            ...
            @if ($showingQrCode)
                ...
                @if ($showingConfirmation)
                    <div class="mt-4">
                        ...
                        <x-input autocomplete="one-time-code" autofocus class="mt-1 block w-1/2" id="code"
                            inputmode="numeric" name="code" type="text"
                            wire:keydown.enter="confirmTwoFactorAuthentication" wire:model="code" />
            ...
            @else
                ...
                @elseif ($showingConfirmation)
                    <x-confirms-password wire:then="confirmTwoFactorAuthentication">
                        <x-primary-button class="me-3" type="button" wire:loading.attr="disabled">
                            {{ __('Confirm') }}
                        </x-primary-button>
                    </x-confirms-password>
                @else
